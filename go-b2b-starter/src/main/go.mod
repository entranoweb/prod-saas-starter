module github.com/moasq/go-b2b-starter/main

go 1.25

require (
	github.com/joho/godotenv v1.5.1
	github.com/moasq/go-b2b-starter/api v0.0.0
	...
	github.com/moasq/go-b2b-starter/docs v0.0.0
	github.com/moasq/go-b2b-starter/pkg/auth v0.0.0
	github.com/moasq/go-b2b-starter/pkg/db v0.0.0
	github.com/moasq/go-b2b-starter/pkg/eventbus v0.0.0
	github.com/moasq/go-b2b-starter/pkg/file_manager v0.0.0
	github.com/moasq/go-b2b-starter/pkg/llm v0.0.0
	...
	github.com/moasq/go-b2b-starter/pkg/redis v0.0.0
	github.com/moasq/go-b2b-starter/pkg/stytch v0.0.0
	github.com/moasq/go-b2b-starter/server v0.0.0
...
require (
	...
	github.com/moasq/go-b2b-starter/pkg/api v0.0.0 // indirect
	github.com/moasq/go-b2b-starter/pkg/common v0.0.0 // indirect
...
replace github.com/moasq/go-b2b-starter/api => ../api

replace github.com/moasq/go-b2b-starter/app/organizations => ../app/organizations

replace github.com/moasq/go-b2b-starter/docs => ../docs
